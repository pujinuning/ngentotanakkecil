...
export default async function Video({ params }: PageProps) {
    ...
    if (data.status !== 200) {
        ...
        url: `https://ngentotanakkecil.pages.dev/v/${file.file_code}#${file.file_title}`,
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://ngentotanakkecil.pages.dev/v/${file.file_code}#${file.file_title}`
            }  
        }
        }
